...
const content = {
  en: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Our Systems", desc: "35 integrated AI systems" },
  ...
  bm: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Sistem Kami", desc: "35 sistem AI bersepadu" },
  ...
  cn: {
    ...
    navItems: [
      ...
      { id: "systems", title: "我们的系统", desc: "35个集成 AI 系统" },
  ...
  id: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Sistem Kami", desc: "35 sistem AI terintegrasi" },
  ...
  vn: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Hệ Thống Của Chúng Tôi", desc: "35 hệ thống AI tích hợp" },
  ...
  ar: {
    ...
    navItems: [
      ...
      { id: "systems", title: "أنظمتنا", desc: "35 نظام ذكاء اصطناعي متكامل" },
  ...
  th: {
    ...
    navItems: [
      ...
      { id: "systems", title: "ระบบของเรา", desc: "35 ระบบ AI ที่เชื่อมต่อกัน" },

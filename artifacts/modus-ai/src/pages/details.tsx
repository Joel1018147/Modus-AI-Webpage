...
const detailsContent = {
  en: {
    ...
    courses: {
      ...
      subtitle: "12 MIIT-workplace certified and 1000+ AI professional programmes. Click any course to see the full summary, features, and benefits.",
      headers: { no: "#", title: "Course Title", features: "Key Features", benefits: "Core Benefits", duration: "Duration", recognition: "Recognition" },
      ...
      items: [
        {
          ...
          duration: "29h 35m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "Not available", recognition: "MIIT / IITC",
        },
        {
        ...
        },
        {
          ...
          duration: "25h 57m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "43h 35m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "48h 39m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "27h 10m", recognition: "MIIT / IITC",
        },
        {
        ...
        },
        {
          ...
          duration: "12h 35m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "12h 17m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "15h 25m", recognition: "MIIT / IITC",
        },
      ],
    },
    activities: {
  ...
  bm: {
    ...
    courses: {
      title: "Kursus",
      titleHighlight: "Kami",
      subtitle: "12 bertauliah tempat kerja MIIT dan 1000+ program AI profesional. Klik mana-mana kursus untuk melihat ringkasan lengkap, ciri-ciri, dan manfaat.",
      headers: { no: "#", title: "Tajuk Kursus", features: "Ciri-ciri Utama", benefits: "Manfaat Utama", duration: "Tempoh", recognition: "Pengiktirafan" },
      ...
      items: [
        {
          ...
          duration: "29j 35m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "Tidak tersedia", recognition: "MIIT / IITC",
        },
        {
        ...
        },
        {
          ...
          duration: "25j 57m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "43j 35m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "48j 39m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "27j 10m", recognition: "MIIT / IITC",
        },
        {
        ...
        },
        {
          ...
          duration: "12j 35m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "12j 17m", recognition: "MIIT / IITC",
        },
        {
          ...
          duration: "15j 25m", recognition: "MIIT / IITC",
        },
      ],
    },
    activities: {
  ...
  cn: {
    ...
    courses: {
      ...
      subtitle: "12个MIIT职场认证及1000+个AI专业项目。点击任一课程查看完整摘要、特点与收益。",
      headers: { no: "#", title: "课程名称", features: "核心特点", benefits: "核心收益", duration: "时长", recognition: "认证" },
      ...
      items: [
        { no: "01", title: "AI 人力资源经理", summary: "复合型HR管理认证，面向将AI技术应用于人才招聘、培训、绩效管理与HR运营的专业人员。由DeepSeek驱动并经MIIT认证。", features: ["DeepSeek驱动的HR工作流", "AI辅助文档与招聘", "人才管理系统", "AI绩效辅导", "集团公司岗位管理"], benefits: ["HR生产力提升5–10倍", "全球标准MIIT资质", "AI驱动人才管道", "自动化合规文档", "引领数字HR转型"], duration: "29小时35分", recognition: "MIIT / IITC" },
        { no: "02", title: "职场AI应用专家", summary: "面向核心办公场景的AI工具熟练度认证，包括文档撰写、PPT设计、数据分析、客户服务和直播运营。", features: ["DeepSeek办公自动化", "AI驱动的PPT与视觉设计", "职场数据分析", "客户服务AI集成", "企业内容与营销AI"], benefits: ["大幅减少重复任务", "更快产出专业成果", "跨职能AI流利度", "加速职业发展的资质", "适用于所有行业"], duration: "暂未开放", recognition: "MIIT / IITC" },
        { no: "03", title: "AI 财务经理", summary: "跨学科认证，将财务专长与AI技术结合，推动财务数字化转型，包括预算、风险控制、税务合规和智能审计。", features: ["AI驱动的预算与预测", "智能采购系统", "税务合规自动化", "AI审计与风险穿透", "DeepSeek财务数据清洗"], benefits: ["更明智的财务决策", "自动化合规工作流", "降低财务风险", "端到端成本可视化", "面向未来的财务领导力"], duration: "暂未开放", recognition: "MIIT / IITC" },
        { no: "04", title: "AI 心理咨询顾问", summary: "结合AI技术与心理学理论的专业认证，提供数字化心理健康支持服务，包括AI辅助治疗、伦理框架和基于智能体的咨询工具。", features: ["AI咨询工具集成", "治疗中AI的伦理使用", "AI表达性艺术治疗", "基于智能体的咨询系统", "面向咨询师的AI知识库"], benefits: ["数字化扩展治疗覆盖", "现代循证实践", "伦理合规的AI使用", "构建专属咨询智能体", "跨境认可资质"], duration: "暂未开放", recognition: "MIIT / IITC" },
        { no: "05", title: "人工智能训练师", summary: "AI产品应用能力认证，涵盖数据管理、算法配置、大模型原理与提示工程——使持证者具备培训他人AI的资格。", features: ["DeepSeek提示工程精通", "大模型原理（50分钟）", "AIGC核心技能", "算法与数据配置", "MIIT中级AI认证"], benefits: ["成为认证AI训练师", "培训团队与组织", "深度理解AI模型", "高需求职业定位", "MIIT与IITC双认证"], duration: "25小时57分", recognition: "MIIT / IITC" },
        { no: "06", title: "智能体开发师", summary: "使用Coze、FastGPT、Dify等平台构建与优化AI智能体的专业认证。涵盖企业智能体部署、RAG设计与知识库构建。", features: ["Coze与Dify智能体开发", "RAG设计与知识库", "AI智能体训练与优化", "企业多平台部署", "本地化智能体构建"], benefits: ["构建定制企业AI智能体", "自动化复杂工作流", "AI工程领域的竞争优势", "部署生产级智能体", "新兴高价值技能"], duration: "43小时35分", recognition: "MIIT / IITC" },
        { no: "07", title: "AI 产品经理", summary: "全生命周期AI产品管理认证，涵盖技术评估、用户研究、商业价值创造与职业发展——为领导AI产品的PM设计。", features: ["AI产品全生命周期管理", "DeepSeek用户洞察", "AI外呼平台设计", "简历与面试AI准备", "OpenClaw企业应用"], benefits: ["领导AI产品团队", "市场就绪的PM资质", "创造商业AI价值", "职业晋升工具", "MIIT与IITC认可"], duration: "48小时39分", recognition: "MIIT / IITC" },
        { no: "08", title: "AI 数据分析师", summary: "面向使用AI深度分析企业数据并提供可执行决策洞察的专业人员的认证。涵盖Python、MySQL、AI数据建模与预测分析。", features: ["Python与MySQL数据基础", "AI数据建模与挖掘", "预测分析管道", "商业智能仪表板", "DeepSeek数据分析规则"], benefits: ["数据驱动的决策权威", "自动化复杂报表", "预测性业务洞察", "跨行业适用性", "高需求分析资质"], duration: "27小时10分", recognition: "MIIT / IITC" },
        { no: "09", title: "AI 营销师", summary: "使用AI开发和优化营销策略的专业认证——涵盖AIGC短视频、AI+SEO、内容创作、社群管理与客户获取。", features: ["AIGC短视频营销", "AI+SEO内容策略", "社群与社交AI工具", "AI驱动的广告与文案", "Seedance 2.0视频制作"], benefits: ["精准客户获取", "规模化自动内容", "可衡量的活动ROI", "现代数字营销优势", "定义职业的AI资质"], duration: "27小时10分", recognition: "MIIT / IITC" },
        { no: "10", title: "AIGC 应用工程师", summary: "证明AIGC工具实施、场景化解决方案设计与业务集成精通能力的权威资质——面向使用大模型构建应用的专业人员。", features: ["大模型应用开发", "AIGC工具实施", "场景化解决方案设计", "业务集成能力", "从入门到专家的学习路径"], benefits: ["权威专业资质", "AI技术能力证明", "构建复杂AI应用", "业务就绪的AI工程", "各行业认可"], duration: "12小时35分", recognition: "MIIT / IITC" },
        { no: "11", title: "OpenClaw 开发工程师", summary: "面向智能体开发的核心技能认证，使用OpenClaw平台引领AI应用工程的技术革命。", features: ["智能体核心开发", "AI应用工程", "OpenClaw平台精通", "企业智能体集成", "新兴AI技术栈"], benefits: ["引领AI开发革命", "前沿工程技能", "高价值细分资质", "企业部署能力", "面向未来的职业道路"], duration: "12小时17分", recognition: "MIIT / IITC" },
        { no: "12", title: "OpenClaw 职场应用专家", summary: "成为AI时代的'职场智能体指挥官'。本认证为专业人员配备高效AI办公工具、智能工作流与企业自动化能力。", features: ["高效AI办公工作流", "智能职场自动化", "OpenClaw专家培训", "企业AI指挥技能", "AI时代生产力系统"], benefits: ["用AI重塑日常工作", "成为不可或缺的人才", "引领团队AI采用", "即时生产力提升", "职场领导力资质"], duration: "15小时25分", recognition: "MIIT / IITC" },
      ],
    },
    activities: {
  ...
  id: {
    ...
    courses: {
      ...
      subtitle: "12 bersertifikat tempat kerja MIIT dan 1000+ program AI profesional. Klik kursus mana pun untuk melihat ringkasan, fitur, dan manfaat lengkapnya.",
      headers: { no: "#", title: "Judul Kursus", features: "Fitur Utama", benefits: "Manfaat Utama", duration: "Durasi", recognition: "Pengakuan" },
  ...
  vn: {
    ...
    courses: {
      ...
      subtitle: "12 chứng nhận nơi làm việc MIIT và hơn 1000 chương trình AI chuyên nghiệp. Nhấp vào bất kỳ khóa học nào để xem tóm tắt, tính năng và lợi ích đầy đủ.",
      headers: { no: "#", title: "Tên Khóa Học", features: "Tính Năng Chính", benefits: "Lợi Ích Cốt Lõi", duration: "Thời Lượng", recognition: "Công Nhận" },
  ...
  ar: {
    ...
    courses: {
      ...
      subtitle: "12 معتمدة من MIIT لمكان العمل و1000+ برنامج مهني للذكاء الاصطناعي. انقر على أي دورة لرؤية الملخص الكامل والميزات والفوائد.",
      headers: { no: "#", title: "عنوان الدورة", features: "الميزات الرئيسية", benefits: "الفوائد الأساسية", duration: "المدة", recognition: "الاعتراف" },
  ...
  th: {
    ...
    courses: {
      ...
      subtitle: "12 หลักสูตรรับรองสถานที่ทำงานจาก MIIT และอีกกว่า 1000 หลักสูตรวิชาชีพ AI คลิกที่หลักสูตรใดก็ได้เพื่อดูสรุปฉบับเต็ม คุณสมบัติ และประโยชน์",
      headers: { no: "#", title: "ชื่อหลักสูตร", features: "คุณสมบัติหลัก", benefits: "ประโยชน์หลัก", duration: "ระยะเวลา", recognition: "การรับรอง" },
                          ...
                          <table className="w-full text-xs border-collapse min-w-[560px]">
                            <thead>
                              <tr className="border-b border-white/20">
                                ...
                                <th className="text-left py-2 px-3 font-display font-bold text-primary/70 uppercase tracking-wider w-[12%]">{t.courses.headers.duration}</th>                                <th className="text-left py-2 px-3 font-display font-bold text-primary/70 uppercase tracking-wider">{t.courses.headers.recognition}</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr className="align-top">
                                ...
                                <td className="py-3 px-3 text-white/80 whitespace-nowrap">{course.duration}</td>                                <td className="py-3 px-3">
